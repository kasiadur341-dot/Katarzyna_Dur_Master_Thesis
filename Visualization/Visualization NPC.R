...
# Subset metadata for NPCs: 1.5Mb carriers (d8, d9) vs control (c11)
...
# Significant genes
sig_genes_entrez <- na.omit(res_df$entrezgene_id[res_df$padj < 0.05 & abs(res_df$log2FoldChange) > 0.56])
