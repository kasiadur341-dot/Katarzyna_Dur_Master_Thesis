...
# Filter metadata for NPCs: 1.5Mb carriers vs controls
...
print(final_plot)
ggsave("Top10_NPC_DEG_barplots_1.5Mb_vs_Control_A4.pdf", titled_plot, width = 11.7, height = 8.3)
...
ggsave("GO_BP_Top10_1.5Mb_vs_Control.pdf", go_plot, width = 11.7, height = 8.3)
...
ggsave("Enriched_Pathways_Top20_1.5Mb_vs_Control.pdf", pathway_plot, width = 11.7, height = 8.3)
